...
void saveMeshVTS() {
  selectOutput("Select or specify .vts file where the mesh will be saved", "saveMeshVTS");  // Opens file chooser
  }
...
Mesh loadMeshVTS() {
  selectInput("Select .vts mesh file to load", "loadMeshVTS");  // Opens file chooser
  return this;
 }
