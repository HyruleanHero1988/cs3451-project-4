...
// ******************************************************************************************** LACING ***************
  ...
  void resample(int nn) { // resamples the curve with new nn vertices
   ...
   void save() {
    selectOutput("Select or specify .pts file where the curve points will be saved", "save");  // Opens file chooser
    }
  ...
  void load() {
    selectInput("Select .pts file to load for the curve", "loadPath");  // Opens file chooser
    }
